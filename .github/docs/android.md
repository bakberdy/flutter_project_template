...
| -------------- | ------------------------------------- |
| `production`   | `com.bakberdi.template`             |
| `development`  | `com.bakberdi.template.development` |
...
4. **App permissions** tab → **Add app** → add **all flavor apps you ship** (`com.bakberdi.template`, `com.bakberdi.template.development`). The apps must already exist (Step B1).
