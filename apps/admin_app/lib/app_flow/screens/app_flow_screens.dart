...
@RoutePage()
class AdminAppFlowScreen extends StatelessWidget {
  const AdminAppFlowScreen({super.key});
...
class UserLoggedOutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => _UserStateScaffold(
    title: 'Logged out',
    description: 'The admin user must sign in before entering the app.',
    primaryLabel: 'Log in',
...
class UserOnboardingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => _UserStateScaffold(
    ...
    description: 'The admin user has not completed onboarding.',
...
class UserProfileRequiredScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => _UserStateScaffold(
    ...
    description: 'The admin user must fill profile data before entering.',
...
class UserHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: AppBar(
      title: const Text('Admin authorized zone'),
      actions: [
        IconButton(
          tooltip: 'Log out',
...
class AuthorizedDashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => _UserStateScaffold(
    ...
    description: 'This is the initial screen inside the admin authorized zone.',
...
class AuthorizedDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => _UserStateScaffold(
    title: 'Admin details',
    description: 'Authorized admin details route id: $id',
...
class AuthorizedSettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => _UserStateScaffold(
    ...
    description: 'This route is still inside the admin authorized zone.',
    primaryLabel: 'Pop',
