...
/// generated route for
/// [AdminAppFlowScreen]
class AdminAppFlowRoute extends PageRouteInfo<void> {
  const AdminAppFlowRoute({List<PageRouteInfo>? children})
    : super(AdminAppFlowRoute.name, initialChildren: children);

  static const String name = 'AdminAppFlowRoute';

  static PageInfo page = PageInfo(
    name,
    builder: (data) {
      return const AdminAppFlowScreen();
    },
  );
}
