...
typedef ChangeUserRoleParams = ({String userId, UserRole role});

@lazySingleton
class ChangeUserRoleUseCase extends UseCase<User, ChangeUserRoleParams> {
  ChangeUserRoleUseCase(this._repository);

  final UsersRepository _repository;

  @override
  FutureEither<User> call(ChangeUserRoleParams params) =>
