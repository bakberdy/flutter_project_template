...
typedef ChangeUserStatusParams = ({String userId, UserStatus status});

@lazySingleton
class ChangeUserStatusUseCase extends UseCase<User, ChangeUserStatusParams> {
  ChangeUserStatusUseCase(this._repository);

  final UsersRepository _repository;

  @override
  FutureEither<User> call(ChangeUserStatusParams params) =>
