...
class ThemeStarted implements ThemeEvent {
 ...
 final  UserTheme systemThemeMode;
...
mixin _$ThemeState {
 ...
 UserTheme? get themeMode; UserTheme? get systemThemeMode; UserTheme? get appliedThemeMode; StateStatus get status;
...
@useResult
$Res call({
 UserTheme? themeMode, UserTheme? systemThemeMode, UserTheme? appliedThemeMode, StateStatus status
});
...
as UserTheme?,systemThemeMode: freezed == systemThemeMode ? _self.systemThemeMode : systemThemeMode // ignore: cast_nullable_to_non_nullable
as UserTheme?,appliedThemeMode: freezed == appliedThemeMode ? _self.appliedThemeMode : appliedThemeMode // ignore: cast_nullable_to_non_nullable
as UserTheme?,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as StateStatus,
  ));
}
/// Create a copy of ThemeState
...
@override final  UserTheme? themeMode;
@override final  UserTheme? systemThemeMode;
@override final  UserTheme? appliedThemeMode;
