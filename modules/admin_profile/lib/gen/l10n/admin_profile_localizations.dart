...
import 'admin_profile_localizations_en.dart';
import 'admin_profile_localizations_kk.dart';
import 'admin_profile_localizations_ru.dart';

// ignore_for_file: type=lint

/// Callers can lookup localized strings with an instance of AdminProfileLocalizations
/// returned by `AdminProfileLocalizations.of(context)`.
///
/// Applications need to include `AdminProfileLocalizations.delegate()` in their app's
/// `localizationDelegates` list, and the locales they support in the app's
/// `supportedLocales` list. For example:
///
/// ```dart
/// import 'l10n/admin_profile_localizations.dart';
///
/// return MaterialApp(
///   localizationsDelegates: AdminProfileLocalizations.localizationsDelegates,
///   supportedLocales: AdminProfileLocalizations.supportedLocales,
...
/// be consistent with the languages listed in the AdminProfileLocalizations.supportedLocales
/// property.
abstract class AdminProfileLocalizations {
  AdminProfileLocalizations(String locale)
    : localeName = intl.Intl.canonicalizedLocale(locale.toString());

  final String localeName;

  static AdminProfileLocalizations of(BuildContext context) {
    return Localizations.of<AdminProfileLocalizations>(
      context,
      AdminProfileLocalizations,
    )!;
  }

  static const LocalizationsDelegate<AdminProfileLocalizations> delegate =
      _AdminProfileLocalizationsDelegate();
...
class _AdminProfileLocalizationsDelegate
    extends LocalizationsDelegate<AdminProfileLocalizations> {
  const _AdminProfileLocalizationsDelegate();

  @override
  Future<AdminProfileLocalizations> load(Locale locale) {
    return SynchronousFuture<AdminProfileLocalizations>(
      lookupAdminProfileLocalizations(locale),
    );
  }
  ...
  @override
  bool shouldReload(_AdminProfileLocalizationsDelegate old) => false;
}

AdminProfileLocalizations lookupAdminProfileLocalizations(Locale locale) {
  // Lookup logic when only language code is specified.
  switch (locale.languageCode) {
    case 'en':
      return AdminProfileLocalizationsEn();
    case 'kk':
      return AdminProfileLocalizationsKk();
    case 'ru':
      return AdminProfileLocalizationsRu();
  }

  throw FlutterError(
    'AdminProfileLocalizations.delegate failed to load unsupported locale "$locale". This is likely '
