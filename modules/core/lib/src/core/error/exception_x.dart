import 'package:core/src/core/error/base_http_error_mapper.dart';
import 'package:core/src/core/error/base_http_error_model.dart';
import 'package:core/src/core/utils/typedef.dart';
...
extension ExceptionX on Exception {
  Future<Failure> toFailure({required String source}) async {
    ...
    if (e is ApiException) {
      ...
      BaseHttpErrorModel? error;
      try {
        error = BaseHttpErrorModel.fromJson(data ?? {});
      } catch (_) {
        error = null;
      }
