...
import 'package:client_auth/src/features/sessions/data/models/session_model/session_model.dart';
...
class SessionsRemoteDataSourceImpl implements SessionsRemoteDataSource {
  ...
  Future<void> revokeSession(String sessionId) async {
    await _apiClient.delete<void>(AuthApiEndpoints.sessionById(sessionId));
  }

  @override
  Future<void> revokeAllSessions() async {
    await _apiClient.delete<void>(AuthApiEndpoints.sessions);
  }
}
