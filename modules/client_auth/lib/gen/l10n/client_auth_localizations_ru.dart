...
class ClientAuthLocalizationsRu extends ClientAuthLocalizations {
  ...
  @override
  String get authOtpLabel => 'Одноразовый код';
  ...
  @override
  String get baseDefaultMessage => 'Что-то пошло не так. Повторите попытку.';
  ...
  @override
  String get devClearAuthTokens => 'Очистить токены';

  @override
  String get devTokensCleared => 'Токены очищены';
  ...
  @override
  String get navigationHomeTitle => 'Главная';
  ...
  String get parseFailureDefaultMessage =>
      'Не удалось прочитать ответ. Повторите попытку.';
  ...
  @override
  String get sessionRevokedBadge => 'Отозван';
  ...
  @override
  String get sessionsLoadMore => 'Загрузить ещё';
  ...
  String get secureConnectionErrorMessage =>
      'Ошибка безопасного подключения. Повторите попытку.';
