...
import 'package:client_shell/src/features/main_navigation/presentation/observers/bottom_nav_visibility_observer.dart';
import 'package:client_shell/src/features/main_navigation/presentation/providers/scroll_to_top_provider.dart';
import 'package:client_shell/src/features/main_navigation/presentation/widgets/nav_bar.dart';
import 'package:client_shell/src/features/main_navigation/presentation/widgets/nav_bar_item.dart';
  ...
  Widget build(BuildContext context) => ScrollToTopProvider(
    ...
    child: AutoTabsRouter(
      ...
      builder: (context, child) {
        ...
        final l10n = ClientShellLocalizations.of(context);
        return Scaffold(
          extendBody: true,
          body: child,
